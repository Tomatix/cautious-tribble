...
class Jarvis:
	def __init__(self, top=None):
		...
		Clear_Button.place(relx=0.74, rely=0.76, height=85, width=175)
		...
		Enter_Button.place(relx=0.74, rely=0.52, height=85, width=175)
		...
		Ring_Button.place(relx=0.74, rely=0.29, height=85, width=175)
		...
		Entry1.configure(background="#2b287a", borderwidth="0", disablockforeground="#a3a3a3", font=font12, foreground="white", highlightbackground="#d9d9d9", highlightcolor="black", insertbackground="black", insertborderwidth="1", justify=CENTER, selectbackground="#007878d7d777", selectforeground="#ffffffffffff", textvariable=display)
